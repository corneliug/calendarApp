...
GoogleCalendar.prototype.listMe = function(access_token, option, callback) {

    return this.sendRequest('get','https://www.googleapis.com/plus/v1/people/me?access_token='+access_token, access_token, option, callback)
}
