...
GooglePlus.prototype.retrieveFriendProfiles = function(id, a, b /* id, callback || id, opts, callback */) {
    return makeRequest(this.apiKey, 'people/' + id + '/people/visible', b === undefined ? {} : a, b === undefined ? a : b);
};
